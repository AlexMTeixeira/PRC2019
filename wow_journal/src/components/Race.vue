<template>
  <v-container>
    <v-card dark ma-2>
        <v-layout>
            <v-flex xs5 ma-2>
                <v-card-title primary-title>
                    <div class="display-3 font-weight-bold font-italic">{{name}}</div>
                </v-card-title>
            </v-flex>
            <v-flex xs7 ma-2>
                <v-img
        ...
        <v-layout>
            <v-flex xs5>
                <v-card-title primary-title><div class="headline">Racials</div></v-card-title>
            ...
            <v-flex xs7>
                <v-card-title primary-title><div class="headline">Starting Zone</div></v-card-title>
                <v-container>
                <v-img ml-2
